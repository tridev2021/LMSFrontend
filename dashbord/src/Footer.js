...
const FooterPagePro = () => { 
  return (
    <MDBFooter style={{backgroundColor:"#000"}} className=" mx font-small pt-4 mt-4" >
      <MDBContainer className="text-center text-md-left" >
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          <MDBCol md="3" lg="3" xl="3" className="mx-auto mt-3">
            <h6 style={{color:"white"}} className="text-uppercase mb-4 font-weight-bold">
              Realcoderz
            </h6>
            <p style={{color:"grey"}}>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            <h6 className="text-uppercase mb-4 font-weight-bold" style={{color:"white"}}>Contact</h6>
            <p style={{color:"grey"}}>
