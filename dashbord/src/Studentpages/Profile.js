		...
		<div class="col-div-8">
			<div class="box-8">
				<div class="content-box">
					...
					<div class="input-field">
                        <input placeholder="DateOfBirth" id="dateOfBirth" name="dateOfBirth"  onChange={this.dateOfBirthChangeHandler} value={this.state.dateOfBirth} type="date" class="validate"/>
                    </div><br/>
